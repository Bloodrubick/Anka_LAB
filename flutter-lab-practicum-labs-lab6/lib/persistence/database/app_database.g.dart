...
class $FavoritePlacesTableTable extends FavoritePlacesTable
  ...
  @override
  late final GeneratedColumnWithTypeConverter<PlaceType, int> type =
      GeneratedColumn<int>(
        'type',
        aliasedName,
        false,
  ...
  static JsonTypeConverter2<PlaceType, int, int> $convertertype =
      const EnumIndexConverter<PlaceType>(PlaceType.values);
  static TypeConverter<List<String>, String> $converterimages =
      const ListStringConverter();
}

class FavoritePlacesTableData extends DataClass
    implements Insertable<FavoritePlacesTableData> {
  final int id;
  final int placeId;
  final String name;
  ...
  @override
  int get hashCode =>
      Object.hash(id, placeId, name, description, type, images, lat, lon);
  @override
...
class FavoritePlacesTableCompanion
    extends UpdateCompanion<FavoritePlacesTableData> {
  final Value<int> id;
...
class HistorySearchTableData extends DataClass
    implements Insertable<HistorySearchTableData> {
  final int id;
  ...
  HistorySearchTableData copyWith({int? id, String? keyword}) =>
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is HistorySearchTableData &&
          other.id == this.id &&
          other.keyword == this.keyword);
}

class HistorySearchTableCompanion
    extends UpdateCompanion<HistorySearchTableData> {
  final Value<int> id;
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $HistorySearchTableTable historySearchTable =
      $HistorySearchTableTable(this);
...
class $$FavoritePlacesTableTableFilterComposer
    extends Composer<_$AppDatabase, $FavoritePlacesTableTable> {
  ...
  ColumnWithTypeConverterFilters<PlaceType, PlaceType, int> get type =>
      $composableBuilder(
        column: $table.type,
...
class $$HistorySearchTableTableFilterComposer
    extends Composer<_$AppDatabase, $HistorySearchTableTable> {
...
class $$HistorySearchTableTableOrderingComposer
    extends Composer<_$AppDatabase, $HistorySearchTableTable> {
...
class $$HistorySearchTableTableAnnotationComposer
    extends Composer<_$AppDatabase, $HistorySearchTableTable> {
