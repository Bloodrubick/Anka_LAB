...
// in surf_mad_teacher_training/test/unit/feature/search/data/repositories/search_repository_test.dart.
...
import 'package:surf_mad_teacher_training/api/data/filter_places_request_dto.dart'
    as _i8;
import 'package:surf_mad_teacher_training/api/data/place_dto.dart' as _i7;
...
class _Fake$HistorySearchTableTable_6 extends _i1.SmartFake
    implements _i2.$HistorySearchTableTable {
  _Fake$HistorySearchTableTable_6(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockApiClient extends _i1.Mock implements _i6.ApiClient {
  ...
  @override
  _i5.Future<List<_i7.PlaceDto>> getFilteredPlaces({
    required _i8.FilterPlacesRequestDto? filter,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#getFilteredPlaces, [], {#filter: filter}),
            returnValue: _i5.Future<List<_i7.PlaceDto>>.value(<_i7.PlaceDto>[]),
          )
          as _i5.Future<List<_i7.PlaceDto>>);

  @override
  _i5.Future<List<_i7.PlaceDto>> getPlaces() =>
      (super.noSuchMethod(
...
/// A class which mocks [HistorySearchDao].
///
/// See the documentation for Mockito's code generation for more information.
class MockHistorySearchDao extends _i1.Mock implements _i9.HistorySearchDao {
  MockHistorySearchDao() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Stream<List<_i2.HistorySearchTableData>> get historySearchStream =>
      (super.noSuchMethod(
            Invocation.getter(#historySearchStream),
            returnValue: _i5.Stream<List<_i2.HistorySearchTableData>>.empty(),
          )
          as _i5.Stream<List<_i2.HistorySearchTableData>>);
  ...
  @override
  _i2.$HistorySearchTableTable get historySearchTable =>
      (super.noSuchMethod(
            Invocation.getter(#historySearchTable),
            returnValue: _Fake$HistorySearchTableTable_6(
              this,
              Invocation.getter(#historySearchTable),
            ),
          )
          as _i2.$HistorySearchTableTable);

  @override
  _i5.Future<void> saveKeyword(_i2.HistorySearchTableCompanion? keyword) =>
      (super.noSuchMethod(
            Invocation.method(#saveKeyword, [keyword]),
  ...
  @override
  _i5.Future<void> removeKeyword(int? keywordId) =>
      (super.noSuchMethod(
            Invocation.method(#removeKeyword, [keywordId]),
            returnValue: _i5.Future<void>.value(),
            returnValueForMissingStub: _i5.Future<void>.value(),
          )
          as _i5.Future<void>);
